...
static int _moddraw_object_info(void *pdr, REGION *clip, int *z, int *drawme) {
    REGION newclip;
    int minx, miny, maxx, maxy;

    DRAWING_OBJECT *dr = (DRAWING_OBJECT *)pdr;
...
static void _moddraw_object_draw(void *pdr, REGION *clip) {
    int b8  = pixel_color8;
