...
static void activate_vpalette() {
    ...
    if ((sys_pixel_format) && (sys_pixel_format->palette)) {
        if (sys_pixel_format->depth > 8) {
            for (n = 0; n < 256; n++)
                sys_pixel_format->palette->colorequiv[n] = SDL_MapRGB(
                    screen->format, sys_pixel_format->palette->rgb[n].r,
            ...
            for (n = 0; n < 256; n++) {
                if (fade_pos.r <= 100)
                    ...
                    vpalette[n].r =
                        ...
                        (255 - sys_pixel_format->palette->rgb[n].r) * (fade_pos.r - 100) / 100;
                ...
                if (fade_pos.g <= 100)
                    ...
                    vpalette[n].g =
                        ...
                        (255 - sys_pixel_format->palette->rgb[n].g) * (fade_pos.g - 100) / 100;
                ...
                if (fade_pos.b <= 100)
                    ...
                    vpalette[n].b =
                        ...
                        (255 - sys_pixel_format->palette->rgb[n].b) * (fade_pos.b - 100) / 100;
            }
