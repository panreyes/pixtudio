...
static inline float isLeft(modChipmunkStruct_Point P0, modChipmunkStruct_Point P1,
                           modChipmunkStruct_Point P2) {
...
int chainHull_2D(modChipmunkStruct_Point *P, int n, modChipmunkStruct_Point *H) {
...
#define encuentraBorde(d)                                                                          \
    if (gr_get_pixel(mapa1, x, y) != 0 && gr_get_pixel(mapa1, x, y) != 0x00ffffff &&               \
        gr_get_pixel(mapa1, x, y) != 0xff000000) {                                                 \
        b          = 1;                                                                            \
        p[cantP].x = x;                                                                            \
        p[cantP].y = y;                                                                            \
        cantP++;                                                                                   \
...
/*
void main(){
modChipmunkStruct_Point p[]={18,51, 36,113, 39,147, 69,75, 73,145, 113,47, 109,142, 140,32, 151,70,
144,118};
