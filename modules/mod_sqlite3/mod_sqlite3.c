...
int modsqlite3_openTable(INSTANCE *my, int *params) {
    ...
    int rc = sqlite3_get_table((sqlite3 *)params[0], text, &resultado->pazResult, &resultado->rows,
...
/*Pendientes: sqlite_get_table, sql_prepare,step,reset y finalize, sqlite_bind_tipodato,
sqlite_column_count ,sqlite_column_tipodato...
