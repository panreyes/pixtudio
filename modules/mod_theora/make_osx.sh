...
llvm-gcc -O2 -m32 -c -Wall -I../../core/include/ -I../../modules/libgrbase/ -I../../modules/libvideo/ -I../../modules/libblit/ -I. -I/opt/local/include -I/sw/include/SDL/ -I/opt/local/include/SDL2 $MODULE.c theoraplay.c
