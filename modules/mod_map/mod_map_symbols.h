...
#ifndef __PXTB__
extern int modmap_map_block_copy( INSTANCE * my, intptr_t * params );
extern int modmap_map_put( INSTANCE * my, intptr_t * params );
extern int modmap_map_xput( INSTANCE * my, intptr_t * params );
extern int modmap_map_xputnp( INSTANCE * my, intptr_t * params );
extern int modmap_new_map( INSTANCE * my, intptr_t * params );
extern int modmap_new_map_extend( INSTANCE * my, intptr_t * params );
extern int modmap_new_map_extend( INSTANCE * my, intptr_t * params );
extern int modmap_map_clear( INSTANCE * my, intptr_t * params );
extern int modmap_map_clone( INSTANCE * my, intptr_t * params );
extern int modmap_map_name( INSTANCE * my, intptr_t * params );
extern int modmap_map_set_name( INSTANCE * my, intptr_t * params );
extern int modmap_map_exists( INSTANCE * my, intptr_t * params );
extern int modmap_map_xputnp( INSTANCE * my, intptr_t * params );
extern int modmap_unload_map( INSTANCE * my, intptr_t * params );
extern int modmap_unload_map( INSTANCE * my, intptr_t * params );
extern int modmap_load_map( INSTANCE * my, intptr_t * params );
extern int modmap_bgload_map( INSTANCE * my, intptr_t * params );
extern int modmap_save_map( INSTANCE * my, intptr_t * params );
extern int modmap_map_buffer( INSTANCE * my, intptr_t * params );
extern int modmap_fpg_add( INSTANCE * my, intptr_t * params );
extern int modmap_fpg_new( INSTANCE * my, intptr_t * params );
extern int modmap_fpg_exists( INSTANCE * my, intptr_t * params );
extern int modmap_load_fpg( INSTANCE * my, intptr_t * params );
extern int modmap_bgload_fpg( INSTANCE * my, intptr_t * params );
extern int modmap_save_fpg( INSTANCE * my, intptr_t * params );
extern int modmap_unload_fpg( INSTANCE * my, intptr_t * params );
extern int modmap_unload_fpg( INSTANCE * my, intptr_t * params );
extern int modmap_rgb_depth( INSTANCE * my, intptr_t * params );
extern int modmap_rgba_depth( INSTANCE * my, intptr_t * params );
extern int modmap_get_rgb_depth( INSTANCE * my, intptr_t * params );
extern int modmap_get_rgba_depth( INSTANCE * my, intptr_t * params );
extern int modmap_rgb( INSTANCE * my, intptr_t * params );
extern int modmap_rgba( INSTANCE * my, intptr_t * params );
extern int modmap_rgb_depth( INSTANCE * my, intptr_t * params );
extern int modmap_rgba_depth( INSTANCE * my, intptr_t * params );
extern int modmap_rgba( INSTANCE * my, intptr_t * params );
extern int modmap_rgba_depth( INSTANCE * my, intptr_t * params );
extern int modmap_get_rgb( INSTANCE * my, intptr_t * params );
extern int modmap_get_rgba( INSTANCE * my, intptr_t * params );
extern int modmap_get_rgb_depth( INSTANCE * my, intptr_t * params );
extern int modmap_get_rgba_depth( INSTANCE * my, intptr_t * params );
extern int modmap_get_rgba( INSTANCE * my, intptr_t * params );
extern int modmap_get_rgba_depth( INSTANCE * my, intptr_t * params );
extern int modmap_fade( INSTANCE * my, intptr_t * params );
extern int modmap_fade_in( INSTANCE * my, intptr_t * params );
extern int modmap_fade_out( INSTANCE * my, intptr_t * params );
extern int modmap_fade_in( INSTANCE * my, intptr_t * params );
extern int modmap_fade_out( INSTANCE * my, intptr_t * params );
extern int modmap_graphic_set( INSTANCE * my, intptr_t * params );
extern int modmap_graphic_info( INSTANCE * my, intptr_t * params );
extern int modmap_graphic_info( INSTANCE * my, intptr_t * params );
extern int modmap_graphic_set( INSTANCE * my, intptr_t * params );
extern int modmap_graphic_info( INSTANCE * my, intptr_t * params );
extern int modmap_colormod_set( INSTANCE * my, intptr_t * params );
extern int modmap_get_point( INSTANCE * my, intptr_t * params );
extern int modmap_set_point( INSTANCE * my, intptr_t * params );
extern int modmap_set_center( INSTANCE * my, intptr_t * params );
extern int modmap_load_fnt( INSTANCE * my, intptr_t * params );
extern int modmap_bgload_fnt( INSTANCE * my, intptr_t * params );
extern int modmap_unload_fnt( INSTANCE * my, intptr_t * params );
extern int modmap_save_fnt( INSTANCE * my, intptr_t * params );
extern int modmap_fnt_new( INSTANCE * my, intptr_t * params );
extern int modmap_fnt_new_charset( INSTANCE * my, intptr_t * params );
extern int modmap_fnt_new_from_bitmap( INSTANCE * my, intptr_t * params );
extern int modmap_fnt_new_charset( INSTANCE * my, intptr_t * params );
extern int modmap_fnt_new_from_bitmap( INSTANCE * my, intptr_t * params );
extern int modmap_load_ttf(INSTANCE *my, intptr_t *params);
extern int modmap_load_bdf( INSTANCE * my, intptr_t * params );
extern int modmap_bgload_bdf( INSTANCE * my, intptr_t * params );
extern int modmap_get_glyph( INSTANCE * my, intptr_t * params );
extern int modmap_set_glyph( INSTANCE * my, intptr_t * params );
extern int modmap_ttf_set_size( INSTANCE * my, intptr_t * params );
extern int modmap_ttf_get_family( INSTANCE * my, intptr_t * params );
extern int modmap_ttf_get_style( INSTANCE * my, intptr_t * params );
extern int modmap_load_png( INSTANCE * my, intptr_t * params );
extern int modmap_bgload_png( INSTANCE * my, intptr_t * params );
extern int modmap_load_pcx( INSTANCE * my, intptr_t * params );
extern int modmap_bgload_pcx( INSTANCE * my, intptr_t * params );
extern int modmap_load_jpg( INSTANCE * my, intptr_t * params );
extern int modmap_bgload_jpg( INSTANCE * my, intptr_t * params );
extern int modmap_load_webp( INSTANCE * my, intptr_t * params );
extern int modmap_bgload_webp( INSTANCE * my, intptr_t * params );
extern int modmap_load_image( INSTANCE * my, intptr_t * params );
extern int modmap_save_png( INSTANCE * my, intptr_t * params );
...
DLSYSFUNCS  __pxtexport( mod_map, exported_functions )[] = {
	...
	FUNC( "IMAGE_LOAD"          , "S"           , TYPE_INT      , modmap_load_image         ),
