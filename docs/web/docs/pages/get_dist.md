...
**INT** get\_dist ( &lt;**INT** processID&gt; )

Returns the distance between the coordinates of a certain
[process](process "wikilink") and the process calling
[get\_dist](get_dist "wikilink")(). The distance returned is converted
to the [resolution](resolution "wikilink") of the process calling
[get\_dist](get_dist "wikilink")().
...
**INT** : The wanted distance.
  ...
  ----- -------------------------------------------------------------
  -1    - An error occurred: invalid [process](process "wikilink").
...
[fget\_dist](fget_dist "wikilink")(), which is easier and doesn't
require an extra [process](process "wikilink"). It also give a much more
accurate distance when the [resolution](resolution "wikilink") is &gt;1.
...
Resolution is 100:
  ...
  [get\_angle](get_angle "wikilink")() and [get\_dist](get_dist "wikilink")() with a [process](process "wikilink")        [fget\_angle](fget_angle "wikilink")() and [fget\_dist](fget_dist "wikilink")()
  ------------------------------------------------------------------------------------------------------------------ ---- ---------------------------------------------------------------------------------
