...
Calculates the size of a [block of memory](memoryblock "wikilink").
Returns the size in [bytes](byte "wikilink").

Parameters
----------

  ------------ ----------------------------------------------------------------------------------------------------------------------------------------------------------
  <datatype>   - The type, i.e. any valid bennu [datatypes](datatypes "wikilink"). Can also be a user defined [types](type "wikilink") or [structs](struct "wikilink").
  ------------ ----------------------------------------------------------------------------------------------------------------------------------------------------------
...
the functions [alloc](alloc "wikilink")(), [calloc](calloc "wikilink")()
and [realloc](realloc "wikilink")(). These three functions allocate
space in [bytes](byte "wikilink"). For instance, an
[int](int "wikilink") in bennu is 4 bytes long. When dealing with data
structures of self-defined [types](type "wikilink"), it can be tedious
to calculate the exact size manually. But this is not the only reason,
for instance, when a linked list is created, the
[struct](struct "wikilink") may be changed by the programmer, and in
...
[calloc](calloc "wikilink")(), [realloc](realloc "wikilink")(),
[struct](struct "wikilink"), [type](type "wikilink"),
[say](say "wikilink")(), [Global](Global "wikilink")
