...
Returns the tangent of a certain [angle](angle "wikilink").

This [function](function "wikilink") performs a tangent calculation on a
certain angle and returns a value.
...
**FLOAT** : The tangent result of the specified
...
[draw\_line](draw_line "wikilink")(), [tan](tan "wikilink")(),
