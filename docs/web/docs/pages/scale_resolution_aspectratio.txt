...
**INT** scale\_resolution\_aspectratio =
[Scale\_resolution\_aspectratio\_modes](Scale_resolution_aspectratio_modes "wikilink").

Description
-----------

**Scale\_resolution\_aspectratio** is a global variable used to choose
between stretching a screen resized by
[scale\_resolution](scale_resolution "wikilink") to fill the screen or
